...
| **4 — release integrity, docs, signing** 🔄 | docs, release CI, signing keys | Honest docs; real minisign + PGP keys (currently committed placeholders — not yet generated); working download-verification chain. 4.D security hardening done; 4.B docs truthfulness in progress |
